...
def register_marriage():
    ...
    try:
        ...
        register = "INSERT INTO marriages(regno,regdate,regplace,p1_fname,p1_lname,p2_fname,p2_lname) VALUES" + "(" + str(
            regno) + ", " + regdate + ", " + "'Manila', " + p1_fname + ", " + p1_lname + ", " + p2_fname + ", " + p2_lname + ")"
...
def renew_reg():
    ...
    if regno in regList:
        ...
        renewDate = "UPDATE registrations SET expiry =" + "DATE(" + "'" + exp + "'" + ",'+1 year') WHERE regno = " + \
                    regno[0] + ";"
        ...
        try:
            ...
            if (payingAmount > 0):
                if (payingAmount > pendingAmount):
                    ...
                    recordPayment = "INSERT INTO payments(tno, pdate, amount) VALUES (" + ticketNum[
                        0] + "," + "'" + todayStr + "'" + "," + str(payingAmount) + ");"
            ...
            print(
                "PAYMENT NOT RECORDED! Either a payment has already been made today for this ticket or the amount entered is not valid.")
...
def insert_person():
    ...
    phone = "'" + input("Enter Phone Number (i.e. ###-###-####): ") + "'"

    insert = "INSERT INTO persons(fname, lname, bdate, bplace, address, phone) VALUES" + "(" + fname + lname + bdate + bplace + address + phone + ")"
    
    cursor.execute(insert)
    print("Registered " + fname + lname)
    connection.commit()
