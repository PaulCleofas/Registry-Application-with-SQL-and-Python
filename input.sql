...
insert into users values ('mickey','mouse','a','Walt', 'Disney','Chicago, US');
insert into users values('chicken','roast','o','Mary','Brown','Nordegg,AB');

SELECT v.make, v.model, v.year, v.color, r.plate,r.regdate, r.expiry, r.fname||" "||r.lname FROM vehicles v, registrations r WHERE r.vin = v.vin and make = 'Doge' and r.regdate IN (SELECT r2.regdate FROM registrations r2 WHERE r2.vin = v.vin ORDER BY r2.regdate DESC LIMIT 1);
